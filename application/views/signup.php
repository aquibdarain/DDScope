                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="contactpage-form shadow rounded">
                                ...
                                <form action="<?php echo base_url('home/Signupdata'); ?>" method="post" class="row g-3" onsubmit="return validateForm()">
                                <?php
...
<div class="col-lg-6 position-relative">
    ...
    <input type="text" class="form-control" name="city" id="validationDefault01" value="" required
...
<script>
    ...
    <div style="display: flex;" class="dropdown">
        ...
        <input type="tel" class="form-control" name="number" id="validationDefault02" value="" required
               oninput="validatePhoneNumber(this)" onblur="clearError('phoneError')" /> </div>
  ...
  function togglePassword(fieldId, buttonId) {
    ...
    if (passwordInput.type === "password") {
      ...
      toggleButton.innerHTML = '<img style="height: 30px;" src="<?php echo base_url("assets/images/closeE.jpg"); ?>" alt="close-eye-icon">';
                                    ...
                                    <div class="col-lg-12" >
                                        <!-- <span  id="submitEnquiry" class="btn enquir-btn" onclick="scrollToTop()" >
                                            SUBMIT
                                        </span> -->
