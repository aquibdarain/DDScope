			...
			<div class="page-main">
				...
				<aside class="app-sidebar" style="overflow: scroll;">
					...
					<ul class="side-menu">
						...
						<!-- <ul class="slide-menu">
							<li>
							<a class="slide-item" href="<?//php echo base_url('admin/banner/addBanner');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">Home Banner</span></a>
							</li>
							
							<li>
							<a class="slide-item" href="<?//php echo base_url('admin/bannerA/addBannerA');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">About Banner</span></a>
							</li>
							
							<li>
							<a class="slide-item" href="<?//php echo base_url('admin/bannerB/addBannerB');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">Services Banner</span></a>
							</li>
							
							<li>
							<a class="slide-item" href="<?//php echo base_url('admin/bannerC/addBannerC');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">Projects Banner</span></a>
							</li>
							
							<li>
							<a class="slide-item" href="<?//php echo base_url('admin/bannerE/addBannerE');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">Products Banner</span></a>
							</li>
							
							<li>
							<a class="slide-item" href="<?//pphp echo base_url('admin/bannerF/addBannerF');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">Team Banner</span></a>
							</li>
							
							<li>
							<a class="slide-item" href="<?//php echo base_url('admin/bannerG/addBannerG');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">Client Banner</span></a>
							</li>
							
							<li>
							<a class="slide-item" href="<?//php echo base_url('admin/bannerH/addBannerH');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">Testimonial Banner</span></a>
							</li>
							
							<li>
							<a class="slide-item" href="<?//php echo base_url('admin/bannerD/addBannerD');?>"><i class="side-menu__icon si si-picture"></i><span class="side-menu__label">Contacts Banner</span></a>
							</li> -->
