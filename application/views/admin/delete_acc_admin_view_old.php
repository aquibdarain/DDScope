 ...
 <div class="row justify-content-between pb-3">
                 ...
                 <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php if ($pageNumber > 1 && !empty($data)) : ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo base_url('admin/Delete_acc/index/1'); ?>"> << First</a>
                            </li>
                        <?php endif; ?>
    ...
    <div class="dropdown show">
        ...
        <div class="dropdown-menu">
            ...
            <form action="<?php echo base_url('admin/Delete_acc/delete_user'); ?>" method="post" onsubmit="return confirm('Are you sure you want to accept this user deletion request?');">
                <input type="hidden" name="reg_id" value="<?php echo $user['reg_id']; ?>">
                <input type="hidden" name="action" value="Accept"> <!-- Set action directly for Accept button -->
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea class="form-control" id="rejectReason" name="rejectReason" rows="5" required style="font-size: 14px; border-color: #9c9da2;"></textarea>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <input type="hidden" name="reg_id" value="<?php echo $user['reg_id']; ?>">
                    <input type="hidden" id="rejectFormAction" name="action" value="">
                    <button type="button" class="btn btn-danger" onclick="prepareReject();">Reject</button>
                </div>
            </div>
        </div>
    </div>
