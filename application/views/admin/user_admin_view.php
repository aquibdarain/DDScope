				...
				<div class="card-header border-bottom">
				 ...
				 <?php if($this->session->flashdata('add_success')) { ?>
                        ...
                        <ul class="pagination">
                            ...
                            <?php if (!empty($data)) : ?>
                                <li class="page-item">
                                    <a class="page-link" href="<?php echo base_url('admin/User/index/1'); ?>"><< First</a>
                                </li>
                                <?php endif; ?>
                    ...
                    <table class="table card-table table-vcenter table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                <form action="<?php echo base_url('admin/User/delete_user'); ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this user?');">
