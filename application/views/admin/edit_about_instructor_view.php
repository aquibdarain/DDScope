                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo base_url('admin/About_instructor_controller/index'); ?>" class="btn btn-secondary">Back</a>
                        </div>
                        <div class="card-body">
                            <?php $attributes = array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data'); ?>
                            <?php echo form_open('admin/About_instructor_controller/edit_aboutus/'.$aboutus['about_id'], $attributes); ?>
                            <div class="row pb-2 mr-3 ml-4">
                                ...
                                <div class="col-xl-6 form-group">
                                    ...
                                    <?php if ($aboutus['about_image']): ?><br>
                                        ...
                                        <img src="<?php echo base_url('/upload/instructors/' . $aboutus['about_image']); ?>" alt="About Image" width="100">
                                    <?php endif; ?>
