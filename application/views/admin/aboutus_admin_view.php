                    ...
                    <div class="card-body">
                        ...
                        <div class="row pb-3">
                            ...
                            <div class="text-right col-md-8 pb-2">
                                ...
                                <a class="btn bg-red btn-sm" href="<?php echo site_url('admin/Aboutus/add_aboutus'); ?>"><i class="fa fa-plus-square"></i>&nbsp;Add</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <?php if (!empty($aboutus)): ?>
                                        ...
                                        <?php foreach ($aboutus as $about): ?>
                                            <?php
                                            $path_to_file = base_url('/upload/aboutus/' . $about['about_image']);
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo site_url('/admin/aboutus/edit_aboutus/' . $about['about_id']); ?>">Edit</a>
                                                            
                                                            <a class="dropdown-item" href="<?php echo site_url('admin/aboutus/delete_aboutus/'.$about['about_id']); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a>
