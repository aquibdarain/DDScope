...
class Home extends CI_Controller
{
	...
	{
		$this->load->view('adsnew');
	}

	public function adsnew1()
	{
	...
	private function sendsignindata($email, $password)
	{
		...
		if (empty($captcha_response)) {
			...
			return false; // Terminate function execution
		}
	...
	public function send_reset_email()
	{
		...
		$this->email->set_header('X-Secret-Key', $secret_key);
